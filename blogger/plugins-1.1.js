!(function (t, e) {
  ...
  var Me = {'animation-iteration-count': !(Ne = null), 'column-count': !0, 'fill-opacity': !0, 'flex-grow': !0, 'flex-shrink': !0, 'font-weight': !0, 'line-height': !0, opacity: !0, order: !0, orphans: !0, widows: !0, 'z-index': !0, zoom: !0};
  function De(t, e, r) {
  ...
  var Rn = {extends: Wi, data: {targets: '> .uk-parent', toggle: '> a', content: '> ul'}},
    qn = {
      ...
      data: {dropdown: '.uk-navbar-nav > li', align: Ct ? 'right' : 'left', clsDrop: 'uk-navbar-dropdown', mode: void 0, offset: void 0, delayShow: void 0, delayHide: void 0, boundaryAlign: void 0, flip: 'x', boundary: !0, dropbar: !1, dropbarMode: 'slide', dropbarAnchor: !1, duration: 200, forceHeight: !0, selMinHeight: '.uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle'},
      computed: {
        boundary: function (t, e) {
          var i = t.boundary,
            n = t.boundaryAlign;
  ...
  var Zn = {
    ...
    tr = {
      mixins: [Li, Pn],
      props: {top: null, bottom: Boolean, offset: Number, animation: String, clsActive: String, clsInactive: String, clsFixed: String, clsBelow: String, selTarget: String, widthElement: Boolean, showOnUp: Boolean, targetOffset: Number},
      ...
      update: [
        {
          read: function (t, e) {
            ...
            return (this.top = Math.max(P(er('top', this)), this.topOffset) - this.offset), (this.bottom = n && n - i), (this.inactive = !this.matchMedia), {lastScroll: !1, height: i, margins: De(this.$el, ['marginTop', 'marginBottom', 'marginLeft', 'marginRight'])};
          },
          write: function (t) {
            var e = t.height,
              i = t.margins,
        ...
        },
        {
          read: function (t) {
            var e = t.scroll;
            return void 0 === e && (e = 0), (this.width = (kt(this.widthElement) ? this.widthElement : this.$el).offsetWidth), (this.scroll = window.pageYOffset), {dir: e <= this.scroll ? 'down' : 'up', scroll: this.scroll, visible: kt(this.$el), top: ui(this.placeholder)[0]};
          },
          write: function (t, e) {
            var i = this,
              n = t.initTimestamp;
      ...
      methods: {
        ...
        update: function () {
          ...
          this.bottom && this.scroll > this.bottom - this.offset && (e = this.bottom - this.scroll), De(this.$el, {position: 'fixed', top: e + 'px', width: this.width}), (this.isActive = t), Ee(this.$el, this.clsBelow, this.scroll > this.bottomOffset), ke(this.$el, this.clsFixed);
        },
      },
    };
  function er(t, e) {
  ...
  var kr = {
    ...
    methods: {
      ...
      _show: function (t, e, i) {
        if (((this._transitioner = this._getTransitioner(t, e, this.dir, R({easing: i ? (e.offsetWidth < 600 ? 'cubic-bezier(0.25, 0.46, 0.45, 0.94)' : 'cubic-bezier(0.165, 0.84, 0.44, 1)') : this.easing}, this.transitionOptions))), !i && !t)) return this._transitioner.translate(1), Xt.resolve();
        ...
        Transitioner: function (r, n, o, t) {
          ...
          return {
            ...
            show: function (t, e, i) {
              void 0 === e && (e = 0);
              var n = i ? 'linear' : s;
              return (t -= Math.round(t * X(e, -1, 1))), this.translate(e), r && this.updateTranslates(), (e = r ? e : X(e, 0, 1)), Wr(this.getItemIn(), 'itemin', {percent: e, duration: t, timing: n, dir: o}), r && Wr(this.getItemIn(!0), 'itemout', {percent: 1 - e, duration: t, timing: n, dir: o}), Ve.start(a, {transform: wr(-l * (Ct ? -1 : 1), 'px')}, t, n).then(h.resolve, K), h.promise;
            },
            stop: function () {
              return Ve.stop(a);
            },
            ...
            translate: function (t) {
              ...
              De(a, 'transform', wr(X(e - e * t - l, -Fr(a), jr(a).width) * (Ct ? -1 : 1), 'px')), this.updateTranslates(), r && ((t = X(t, -1, 1)), Wr(this.getItemIn(), 'itemtranslatein', {percent: t, dir: o}), Wr(this.getItemIn(!0), 'itemtranslateout', {percent: 1 - t, dir: o}));
            },
            percent: function () {
    ...
    Jr = {
      ...
      methods: {
        init: function (t) {
          ...
          !r || It(e) || (this.handle && !Tt(e, this.handle)) || 0 < i || Tt(e, '.' + this.clsNoDrag) || n || (t.preventDefault(), (this.touched = [this]), (this.placeholder = r), (this.origin = R({target: e, index: ne(r)}, this.pos)), Ht(document, Dt, this.move), Ht(document, Ot, this.end), Ht(window, 'scroll', this.scroll), this.threshold || this.start(t));
        },
        start: function (t) {
          (this.drag = ae(this.$container, this.placeholder.outerHTML.replace(/^<li/i, '<div').replace(/li>$/i, 'div>'))), De(this.drag, R({boxSizing: 'border-box', width: this.placeholder.offsetWidth, height: this.placeholder.offsetHeight}, De(this.placeholder, ['paddingLeft', 'paddingRight', 'paddingTop', 'paddingBottom']))), Q(this.drag, 'uk-no-boot', ''), ke(this.drag, this.clsDrag, this.clsCustom), ti(this.drag.firstElementChild, ti(this.placeholder.firstElementChild));
          var e = Je(this.placeholder),
            i = e.left,
            n = e.top;
          R(this.origin, {left: i - this.pos.x, top: n - this.pos.y}), ke(this.placeholder, this.clsPlaceholder), ke(this.$el.children, this.clsItem), ke(document.documentElement, this.clsDragState), jt(this.$el, 'start', [this, this.placeholder]), this.move(t);
        },
        move: function (t) {
          if (this.drag) {
            this.$emit();
  ...
  s['fn']['arThemes'] = function (e) {
    this['each'](function (_) {
      var i,
        ...
        n = $(this),
        b = function (_, a) {
          window['console'] && window['console'][_] && window['console'][_](a, 'at', n);
        },
        t = function (_, a) {
          return _ == '' || null == _ ? (a == 'type' ? (b('error', 'Featured Posts Error: ' + a + ' is empty or undeinfed'), !1) : a == 'label' && i['type'] == 'mega' ? (b('error', 'Featured Posts Error: ' + a + ' name is empty or undeinfed'), !1) : a == 'count' ? (b('warn', 'Featured Posts Notice: posts ' + a + ' is empty or undeinfed and replaced with 3 by default'), 3) : a == 'title' && i['type'] == 'related' ? (b('warn', 'Featured Posts Notice: related posts ' + a + ' is empty or undeinfed and replaced with "Related Posts" by default'), 'Related Posts') : ((a != 'postId' && a != 'tags') || i['type'] != 'related' || b('error', 'Featured Posts Error: ' + a + ' is empty or undeinfed. contact theme support'), !1)) : _;
        },
        r = function (_, a, f) {
          return '<' + _ + " class='featured_error" + ('' != a ? ' ' + a : '') + "'><span class='uk-margin-small-right' data-uk-icon='warning'></span><span>" + f + '</span></' + _ + '>';
        },
        l = function (_, a, f) {
          return f == 'related' || f == 'random'
            ? "<li><div class='uk-card uk-card-hover uk-card-default'><div class='post_thumbnail uk-card-media-top uk-text-center uk-position-relative uk-transition-toggle' data-title='" +
                a['title'] +
                "'><a href='" +
                a['link'] +
                "'>" +
                arThemes['thumbGet'](a['thumb'], 510, 286, defaultThumb) +
                "<div class='uk-position-cover uk-transition-fade uk-overlay-primary'/><div class='uk-position-center'><span class='uk-transition-fade' data-uk-icon='icon:" +
                (null != a['thumb'] && (-1 < a['thumb']['indexOf']('youtube') ? 'play-circle' : 'image'))['toString']() +
                ";ratio:2'/></div></a></div><div class='post_content uk-card-small uk-card-body'><h3 class='post_title entry-title uk-margin'><a title='" +
                a['title'] +
                "' href='" +
                a['link'] +
                "' data-uk-tooltip='pos:top-left'>" +
                a['title'] +
                "</a></h3><div class='post_meta uk-grid uk-grid-small'><div class='post_date uk-width-auto'><span class='uk-margin-small-right' data-uk-icon='icon: clock; ratio: .7'/><span>" +
                arThemes['monthGet'](monthsNames, a['datePublished']['month']) +
                ' ' +
                a['datePublished']['day'] +
                ', ' +
                a['datePublished']['year'] +
                '</span></div>' +
                (0 < a['comments'] ? "<div class='post_comments uk-width-auto'><span class='uk-margin-small-right' data-uk-icon='icon:comment;ratio:.7'/><span>" + a['comments'] + '</span></div>' : '') +
                '</div></div></div></li>'
            : f == 'mega'
            ? "<li class='uk-width-1-" +
              _['count'] +
              "@l'><div class='uk-card uk-card-hover uk-card-default'><div class='post_thumbnail uk-card-media-top uk-text-center uk-position-relative uk-transition-toggle' data-title='" +
              a['title'] +
              "'><a href='" +
              a['link'] +
              "'>" +
              arThemes['thumbGet'](a['thumb'], 250, 140, defaultThumb) +
              "<div class='uk-position-cover uk-transition-fade uk-overlay-primary'/><div class='uk-position-center'><span class='uk-transition-fade' data-uk-icon='icon:" +
              (null != a['thumb'] && (-1 < a['thumb']['indexOf']('youtube') ? 'play-circle' : 'image'))['toString']() +
              ";ratio:2'/></div></a></div><div class='post_content uk-card-small uk-card-body'><h3 class='post_title entry-title uk-margin'><a href='" +
              a['link'] +
              "'>" +
              a['title'] +
              "</a></h3><div class='post_meta uk-grid uk-grid-small'><div class='post_date uk-width-auto'><span class='uk-margin-small-right' data-uk-icon='icon: clock; ratio: .7'/><span>" +
      ...
      ((i = s['extend'](!0, {type: n['data']('type'), label: n['data']('label'), count: n['data']('count'), title: n['data']('title'), postId: n['data']('id'), tags: n['data']('tags'), onComplete: function () {}}, e))['type'] = t(i['type'], 'type')),
        (i['label'] = t(i['label'], 'label')),
        (i['count'] = t(i['count'], 'count')),
        (i['title'] = t(i['title'], 'title')),
        (i['postId'] = t(i['postId'], 'postId')),
        (i['tags'] = t(i['tags'], 'tags')),
        (f = i['type'] == 'related' || i['type'] == 'random' ? ((a = '/feeds/posts/default?alt=json&max-results=100'), 'json') : (i['type'] == 'featured' && i['label'] == '_latest' && (a = '/feeds/posts/default?alt=json-in-script&max-results=' + i['count']), (i['type'] != 'featured' && i['type'] != 'mega') || (a = '/feeds/posts/default?alt=json-in-script&category=' + i['label'] + '&max-results=' + i['count']), 'jsonp')),
        $['ajax']({
          url: a,
          dataType: f,
          success: function (_) {
            var a = arThemes['PostsObject'](_),
              f = [],
              b = ['full_title', 'left_side', 'no_side'];
            if (null != a['blogPosts']) {
              if (
                (i['type'] == 'related' &&
                  ((i['tags'] = i['tags']['filter'](function (_) {
                    return b['indexOf'](_) < 0;
                  })),
                  (a['blogPosts'] = a['blogPosts']['filter'](function (_, a) {
                    var f = !1;
                    return (
                      $['each'](_['label'], function (_, a) {
                        if (-1 < i['tags']['indexOf'](a)) return !(f = !0);
                      }),
                      _['id'] != i['postId'] && f
                    );
                  }))),
                i['type'] == 'related' || i['type'] == 'random')
              ) {
                for (var t, e, s = a['blogPosts']['length']; s; ) (e = Math['floor'](Math['random']() * s--)), (t = a['blogPosts'][s]), (a['blogPosts'][s] = a['blogPosts'][e]), (a['blogPosts'][e] = t);
                a['blogPosts'] = a['blogPosts']['slice'](0, i['count']);
              }
              $['each'](a['blogPosts'], function (_, a) {
                (a['title'] = a['title']['replace'](/'/g, '&#39;')), (i['type'] != 'related' && i['type'] != 'random') || f['push'](l(i, a, 'related')), i['type'] == 'mega' && f['push'](l(i, a, 'mega'));
              }),
                0 < f['length']
                  ? (n['html'](''),
                    i['type'] == 'related' && n['append']("<h3 class='post_related_title'><span class='uk-margin-right' data-uk-icon='album'/>" + i['title'] + '</h3>'),
                    (i['type'] != 'related' && i['type'] != 'random') || n['append']("<div class='uk-position-relative' data-uk-slider='autoplay:true;finite:true'><ul class='blog_posts uk-slider-items " + (i['type'] == 'related' ? 'uk-child-width-1-1 uk-child-width-1-3@m' : 'uk-child-width-1-1 uk-child-width-1-3@m uk-child-width-1-4@l') + " uk-grid uk-grid-medium'>" + f['join']('') + "</ul><ul class='uk-slider-nav uk-dotnav uk-flex-center uk-margin-xmedium-top'></ul><a class='" + (i['type'] == 'related' ? '' : 'uk-position-center-left uk-position-small ') + "uk-hidden-hover' href='#' data-uk-slidenav-previous data-uk-slider-item='previous'></a><a class='" + (i['type'] == 'related' ? '' : 'uk-position-center-right uk-position-small ') + "uk-hidden-hover' href='#' data-uk-slidenav-next data-uk-slider-item='next'></a></div>"),
                    i['type'] == 'mega' && n['append']("<ul class='blog_posts uk-grid uk-grid-medium'>" + f['join']('') + '</ul>'))
                  : n['hide']();
            } else (o = !0), n['html'](''), (i['type'] != 'related' && i['type'] != 'random') || n['hide'](), i['type'] == 'mega' && n['append'](r('div', '', 'Label Name Not Found'));
          },
          error: function (_) {
            n['html'](''), 404 == _['status'] ? n['append'](r('div', '', '<strong>Settings</strong> > <strong>Other</strong> > <strong>Site feed</strong> > <strong>Allow Blog Feed</strong> must be set to <strong>Short</strong>')) : 401 == _['status'] ? n['append'](r('div', '', '<strong>Settings</strong> > <strong>Basic</strong> > <strong>Permissions</strong> > <strong>Blog Readers</strong> must be set to <strong>Public</strong>')) : n['append'](r('div', '', 'Unspecified error code ' + _['status'] + '. Contact theme supprt'));
          },
          complete: function () {
            n['removeClass']('uk-text-center'), o || i['onComplete']['call'](this, n);
          },
        });
    });
  };
...
$(function () {
      ...
      $((enableShrinkingForAll ? '' : '#blog_posts ') + '.post_content').each(function () {
        ...
        0 < a.length &&
          $(this).slideUp(400, function () {
            ...
            0 == $('#view-skin-1').length && $('head').append("<style id='view-skin-1' type='text/css'>" + (enableShrinkingForAll ? '' : '#blog_posts ') + '.post_thumbnail + .post_content{display:none}</style>');
          });
      });
    },
    f = function () {
  ...
  a(function () {
    $('.sidenav').after(
      "\x3c!-- .sidemenu --\x3e<div class='sidemenu" +
        (enableLightStyle ? '' : ' uk-light') +
        "' data-uk-offcanvas='overlay:true' id='sidemenu'><div class='uk-offcanvas-bar uk-padding-remove" +
        (enableLightStyle ? '' : ' uk-background-secondary') +
        ...
        textSearch +
        "' value='" +
        (void 0 != h.blog.searchQuery ? h.blog.searchQuery : '') +
        "' name='q' type='search'/></div></form></div></div>\x3c!-- .totop --\x3e<a class='uk-icon-button uk-position-fixed uk-position-medium uk-position-bottom-right hide' data-uk-scroll='' data-uk-tooltip='pos:left' data-uk-totop='' title='" +
        textBackToTop +
        "' href='#!'/>"
    );
  }, !0);
  a(function () {
    $('.mainnav_menu > ul').each(function () {
      ...
      a.find('ul ul').each(function (a) {
        ...
        c.siblings('a')
          .addClass('sd_' + a)
          .append("<span class='uk-margin-left' data-uk-icon='icon:chevron-right;ratio:.75'></span>");
        c.addClass('uk-nav uk-navbar-dropdown-nav uk-list-divider').wrap("<div class='uk-navbar-dropdown' data-uk-drop='mode:hover;delay-hide:100;toggle:.sd_" + a + "'></div>");
      });
      a.find('ul:not(.uk-nav)').each(function () {
        var a = $(this);
        a.siblings('a').append("<span class='uk-margin-xsmall-left' data-uk-icon='icon:chevron-down;ratio:.75'></span>");
        a.addClass('uk-nav uk-navbar-dropdown-nav uk-list-divider').wrap("<div class='uk-navbar-dropdown'></div>");
      });
      a.find('.mega').each(function () {
        var a = $(this);
        a.parent('li');
        !a.parent('li').hasClass('has_mega') && a.siblings('a').append("<span class='uk-margin-xsmall-left' data-uk-icon='icon:triangle-down;ratio:.75'></span>");
      ...
      a.find('.has_mega').each(function () {
        ...
        if (1 < b.length) {
          var k = [],
            e = Math.random().toString().split('.').join('');
          b.each(function () {
            var a = $(this);
            a.wrap('<li><li>');
          ...
          c.after("<div class='uk-width-1-4'><ul class='uk-tab-left' data-uk-tab='connect:#component-tab-left-" + e + ";animation:uk-animation-slide-left-medium,uk-animation-slide-right-medium'>" + k.join('') + '</ul></div>');
          a.find("div[class*='uk-width']").wrapAll("<div class='mega_menu uk-navbar-dropdown'><div class='uk-grid uk-grid-small'></div></div>");
          c.on('click', function () {
            c.hasClass('mega_loaded')
              ? c.off()
              : (b.first().arThemes({
                  type: 'mega',
                  count: 3,
                ...
                a.find('.uk-tab-left li').first().addClass('mega_loaded'));
          });
          a.find('.uk-tab-left li').each(function (a) {
            ...
            c.children('a').on('click', function () {
              c.hasClass('mega_loaded')
                ? c.off()
                : ($('#component-tab-left-' + e + ' li:nth-child(' + (a + 1).toString() + ') .mega').arThemes({
                    type: 'mega',
                    count: 3,
                    onComplete: function () {
                      d();
        ...
        else a.addClass('has_single_mega'),
          b.wrap("<div class='mega_menu uk-navbar-dropdown'></div>"),
      ...
      $('.sidemenu > div').each(function () {
        ...
        a.find('ul,.mega').each(function () {
          ...
          !b.hasClass('drop_title') && b.addClass('drop_title').append("<span data-uk-icon='icon:plus;ratio:.75'/>");
          a.parent('li').addClass('has_drop').attr('data-uk-accordion', 'multiple:true;content:>.drop_content;toggle:>.drop_title').wrapInner('<div></div>');
        });
        a.on('click', '.drop_title', function () {
          var a = $(this);
          'icon:plus;ratio:.75' == a.find('[data-uk-icon]').attr('data-uk-icon') ? a.find('[data-uk-icon]').attr('data-uk-icon', 'icon:minus;ratio:.75') : a.find('[data-uk-icon]').attr('data-uk-icon', 'icon:plus;ratio:.75');
          a.siblings('div').hasClass('drop_content') || a.siblings('div').addClass('drop_content');
        });
        a.find('.has_mega').each(function () {
          var a = $(this),
            b = a.find('.mega'),
            k = a.children('div').children('a');
          b.addClass('uk-text-center');
          b.append("<div data-uk-spinner=''></div>");
          1 < b.length
            ? (a.addClass('has_multi_mega'),
              b.wrapAll("<ul class='drop_content'></ul>"),
              b.wrap("<li class='has_drop' data-uk-accordion='multiple:true;content:>.drop_content;toggle:>.drop_title'><div></div></li>"),
              b.each(function () {
                var a = $(this);
                a.before("<a class='drop_title' href='#!'>" + ('' == a.attr('data-label') ? 'Label Name Not Found' : a.attr('data-label')).toString() + "<span data-uk-icon='icon:plus;ratio:.75'/></a>");
                var b = a.siblings('a'),
                  k = a.parent('li');
                b.on('click', function (c) {
                  c.preventDefault();
                  k.hasClass('mega_loaded')
                    ? b.off()
                    : (a.arThemes({
                        type: 'mega',
                        count: 4,
            ...
            : (a.addClass('has_single_mega'),
              k.on('click', function (c) {
                c.preventDefault();
                a.hasClass('mega_loaded')
                  ? k.off()
                  : (b.arThemes({
                      type: 'mega',
                      count: 4,
  ...
  a(function () {
    $('.blog_pager').on('click', 'a', function (a) {
      ...
      b.hasClass('loading') ||
        (b.addClass('loading'),
        b.removeAttr('data-uk-icon'),
        b.html("<div data-uk-spinner=''></div>"),
        $.ajax({
          url: k,
          type: 'get',
          dataType: 'html',
